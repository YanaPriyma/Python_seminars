...
#  В ответе
# напишите “Парам пам-пам”, если с ритмом все в порядке и “Пам парам”, если с ритмом 
# все не
# в порядке
# Ввод: Вывод:
...
n = input("Введите текст песни: ").split()
list1 = [sum(i in 'аоуыэеёиюя' for i in list2) for list2 in n]
if len(set(list1)) == 1:
    print("Парам пам-пам")
else:
    print("Пам парам")
